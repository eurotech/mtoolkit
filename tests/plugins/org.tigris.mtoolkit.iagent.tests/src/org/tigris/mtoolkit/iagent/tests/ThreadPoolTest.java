...
public class ThreadPoolTest extends TestCase {
   ...
   * creates a pool with length 1 and 3 work units with different lengths. After
   * this, the test asserts that the work units are executed sequentially.
   */
