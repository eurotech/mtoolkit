...
public class RemoteServiceTest extends ServiceManagerTestCase {
	...
	public void testGetBundle() throws IAgentException {
		assertTrue("Service.getBundle() return different bundle!", isEqualsBundles(bundle,
			findService(getAllRemoteServices(TEST_SERVICE_CLASS, FILTER)).getBundle()));
	}
	...
	public void testIllegalStateService() throws Exception {
		...
		PMPConnection pmpConnection = (PMPConnection) connectorSpi.getConnectionManager().createConnection(ConnectionManager.PMP_CONNECTION);
