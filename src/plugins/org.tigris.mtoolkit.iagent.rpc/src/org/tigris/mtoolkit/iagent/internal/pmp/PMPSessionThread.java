...
public class PMPSessionThread extends Thread {
	...
	protected static final byte[] PING = { (byte) PING_REQ_OP }; // 00000000
	protected static final int PING_REPLY_OP = 144;
	protected static final byte[] PING_REPLY = { (byte) PING_REPLY_OP }; // - 16
	// 10000110

	protected static final int CONNECT_REPLY_OP = 1;
	protected static final byte[] CONNECT_REPLY = { (byte) CONNECT_REPLY_OP }; // 00000001
	protected static final int REFERENCE_REPLY_OP = 2;
	protected static final byte[] REFERENCE = { (byte) REFERENCE_REPLY_OP }; // 00000010
	protected static final int SERIALIZED_OBJ_REPLY_OP = 4;
	protected static final byte[] SERIALIZED = { (byte) SERIALIZED_OBJ_REPLY_OP }; // 00000100
	protected static final int EVENT_LISTENER_REPLY_OP = 8;
	protected static final byte[] EV_REPLY = { (byte) EVENT_LISTENER_REPLY_OP }; // 00001000
	protected static final int EVENT_LISTENER_FAILED_REPLY_OP = 24;
	protected static final byte[] EV_FAILED = { (byte) EVENT_LISTENER_FAILED_REPLY_OP }; // 8+16
	// 00011000
	...
	protected static final byte[] METHOD = { (byte) GET_METHOD_REPLY_OP }; // 32+64
	// 01100000
	protected static final int DISCONNECT_REQ_OP = 64;
	protected static final byte[] DISCONNECT = { (byte) DISCONNECT_REQ_OP }; // 01000000

	protected static final int CONNECT_REQ_OP = 129;
	protected static final byte[] CONNECT = { (byte) CONNECT_REQ_OP }; // -1
	// 10000001
	protected static final int GET_REFERENCE_REQ_OP = 130;
	protected static final byte[] GET_REF = { (byte) GET_REFERENCE_REQ_OP }; // -2
	// 10000010
	protected static final int GET_REFERENCE_BY_ID_REQ_OP = 134;
	protected static final byte[] GET_REF_BY_ID = { (byte) GET_REFERENCE_BY_ID_REQ_OP }; // -(2+4)
	// 10000110

	protected static final int INVOKE_METHOD_REQ_OP = 132;
	protected static final byte[] INVOKE = { (byte) INVOKE_METHOD_REQ_OP }; // -4
	// 10000100
	protected static final int INVOKE_METHOD_WITH_REFS_REQ_OP = 140;
	protected static final byte[] INVOKE_R = { (byte) INVOKE_METHOD_WITH_REFS_REQ_OP }; // -
	// (4+8)
	// 10001100

	protected static final int ADD_LISTENER_REQ_OP = 136;
	protected static final byte[] ADD_LS = { (byte) ADD_LISTENER_REQ_OP }; // -8
	// 10001000
	protected static final int REMOVE_LISTENER_REQ_OP = 152;
	protected static final byte[] REMOVE_LS = { (byte) REMOVE_LISTENER_REQ_OP }; // -(8+16)
	// 10011000

	protected static final int GET_METHOD_REQ_OP = 160;
	protected static final byte[] GET_METHOD = { (byte) GET_METHOD_REQ_OP }; // -32
	// 10100000

	protected static final int DISPOSE_REQ_OP = 192;
	protected static final byte[] DISPOSE = { (byte) DISPOSE_REQ_OP }; // -64
	// 11000000
