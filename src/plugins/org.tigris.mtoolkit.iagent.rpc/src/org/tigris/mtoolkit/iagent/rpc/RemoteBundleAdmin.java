...
public interface RemoteBundleAdmin {
   ...
   * 
   * @param id
   * @return the result of the getLastModified() method call or -2 if the bundle
   *         is uninstalled
   */
   ...
   * 
   * @param id
   * @return null in case the bundle has been uninstalled, empty string in case
   *         the bundle is R3 and has no symbolic name or the symbolic name of
   *         the bundle
   */
   ...
   * @param id
   * @param flags
   * @return Error object, describing the problem or null if the bundle has been
   ...
   * 
   * @param id
   * @return array of Dictionary describing the registered services. Empty array
   *         is return in case the bundle is not active, or no services are
   *         registered. Null result is returned if the bundle is uninstalled
   */
   ...
   *         return in case the bundle is not active, or no services are in use
   *         currently. Null result is returned if the bundle is uninstalled
   */
   ...
   *         PackageAdmin service is unavailable. Null result is returned if the
