...
public interface PMPConnection {
   ...
   *          the EventListener
   * @param eventTypes
   *          Array with elements all types of the events which this listener
   *          wants to receive. Custom event types are in the fallowing format
   *          EventListener.CUSTOM_EVENT=custom_event_type;
   *
