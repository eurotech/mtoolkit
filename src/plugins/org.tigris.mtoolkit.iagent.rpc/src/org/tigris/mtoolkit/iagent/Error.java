...
public final class Error implements Externalizable {
  /**
   * This code is only valid with {@link #BUNDLE_EXCEPTION_TYPE} and means that
   * the bundle has been previously uninstalled
   */
  ...
  /* (non-Javadoc)
   * @see org.tigris.mtoolkit.iagent.rpc.Externalizable#readObject(java.io.InputStream)
   */
  ...
  /* (non-Javadoc)
   * @see org.tigris.mtoolkit.iagent.rpc.Externalizable#writeObject(java.io.OutputStream)
   */
