...
class Connection implements PMPConnection {
	...
	protected void disconnected(String errMsg) {
		...
		dump("Connection: disconnecting " + errMsg);
		connected = false;
	 ...
	 * 
	 * @param clazz
	 *            Specifies the interface under which the service was
	 *            registered.
	 * @param filter
	 *            Specifies the search filter (exactly as
	 *            <code>BundleContext getService</code> filter)
	 ...
	 * @return a reference to the service.
	 * @exception PMPException
	 *                If an IOException or protocol error occurred, if the user
	 *                does not have access rigths for this service, or if there
	 *                was no such service registered in the Framework.
	 * @see RemoteObject
	 */
