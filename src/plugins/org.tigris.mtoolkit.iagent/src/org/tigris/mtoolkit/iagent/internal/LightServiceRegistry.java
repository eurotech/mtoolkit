...
public class LightServiceRegistry {
		...
		private void create() {
			if (extender == null) {
				try {
					...
					ERROR("Implementation class constructor visibility of class " + className + " is too restrictive.",
						e);
					extender = EXTENDER_LOAD_FAILED;
				}
			}
	...
	/**
	 * Constructor, which creates a new registry with specified definition
	 * files' name and class loader.
	 * 
	 * @param filename
	 *            the name of the definition files
	 * @param loader
	...
	/**
	 * Queries the registry for all implementations of a service with given
	 * name.
	 * 
	 * @param name
	 *            the name of the service
