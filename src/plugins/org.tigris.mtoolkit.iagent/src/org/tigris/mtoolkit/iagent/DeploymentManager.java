...
public interface DeploymentManager {
   ...
   * @throws IAgentException
   * @throws {@link IllegalArgumentException} if the passed symbolicName is null
   */
   ...
   * @param version
   *          the version of the bundle. In case of null, all bundles with given
   *          symbolic name are returned
   * @return array of RemoteBundle objects. When there are no bundles to return,
  ...
  /**
   * Installs the bundle from the passed {@link InputStream} object and returns
   * RemoteBundle object representing the newly installed bundle. In case of
   * failure, IAgentException is thrown.
   *
   * @param location
