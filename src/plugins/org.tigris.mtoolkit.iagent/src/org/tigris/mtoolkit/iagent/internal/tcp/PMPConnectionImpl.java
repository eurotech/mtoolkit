...
public class PMPConnectionImpl implements PMPConnection, EventListener {
  ...
  public PMPConnectionImpl(Dictionary conProperties, ConnectionManagerImpl connManager) throws IAgentException {
    log("[Constructor] >>> Create PMP Connection: props: " + DebugUtils.convertForDebug(conProperties) + "; manager: " + connManager);
    ...
    pmpConnection.addEventListener(this, new String[] { org.tigris.mtoolkit.iagent.pmp.PMPConnection.FRAMEWORK_DISCONNECTED });
  }
  ...
  public void closeConnection() throws IAgentException {
    ...
    try {
      ...
      pmpConnection.removeEventListener(this, new String[] { org.tigris.mtoolkit.iagent.pmp.PMPConnection.FRAMEWORK_DISCONNECTED });
  ...
  public RemoteObject getRemoteBundleAdmin() throws IAgentException {
    ...
    if (!isConnected()) {
      ...
      throw new IllegalStateException("The connecton has been closed!");
    }
    if (remoteBundleAdmin == null) {
      try {
        ...
        remoteBundleAdmin = new PMPRemoteObjectAdapter(pmpConnection.getReference(REMOTE_BUNDLE_ADMIN, null)) {
          public int verifyRemoteReference() throws IAgentException {
            ...
            try {
              ...
              Long l = (Long)Utils.callRemoteMethod(newRemoteObject, Utils.GET_REMOTE_SERVICE_ID_METHOD, null);
              ...
              remoteServiceAdmin = null;
              this.log("[verifyRemoteReference] Reference to remote service cannot be got, service is not available. Fail fast.",e);
              throw new IAgentException("Unable to retrieve reference to remote administration service", IAgentErrors.ERROR_REMOTE_BUNDLE_ADMIN_NOT_ACTIVE, e);
            }
          }
        };
      } catch (PMPException e) {
  ...
  public RemoteObject getRemoteDeploymentAdmin() throws IAgentException {
    ...
    if (remoteDeploymentAdmin == null) {
      try {
        ...
        remoteDeploymentAdmin = new PMPRemoteObjectAdapter(pmpConnection.getReference(REMOTE_DEPLOYMENT_ADMIN, null)) {
          public int verifyRemoteReference() throws IAgentException {
            if (!pmpConnection.isConnected()){
              this.log("[verifyRemoteReference] The connection has been closed!");
              throw new IllegalStateException("The connection has been closed!");
            ...
            try {
              ...
              remoteDeploymentAdmin = null;
              this.log("[verifyRemoteReference] Reference to remote service cannot be got, service is not available. Fail fast",e);
              IAgentException agentEx = new IAgentException("RemoteDeploymentAdmin is not available", IAgentErrors.ERROR_DEPLOYMENT_ADMIN_NOT_ACTIVE, e);
              throw agentEx;
            }
          }
        };
        ...
        throw new IAgentException("Unable to retrieve reference to remote administration service", IAgentErrors.ERROR_DEPLOYMENT_ADMIN_NOT_ACTIVE, e);
      }
    }
  ...
  public RemoteObject getRemoteParserService() throws IAgentException {
    ...
    if (remoteParserService == null) {
      ...
      try {
        ...
        throw new IAgentException("Unable to retrieve reference to remote administration service", IAgentErrors.ERROR_INTERNAL_ERROR);
      }
    }
        ...
        remoteServiceAdmin = new PMPRemoteObjectAdapter(pmpConnection.getReference(REMOTE_SERVICE_ADMIN, null)) {
          public int verifyRemoteReference() throws IAgentException {
            ...
            try {
              ...
              remoteServiceAdmin = null;
              this.log("[verifyRemoteReference] Reference to remote service cannot be got, service is not available. Fail fast",e);
              throw new IAgentException("Unable to retrieve reference to remote administration service", IAgentErrors.ERROR_REMOTE_SERVICE_ADMIN_NOT_ACTIVE, e);
            }
          }
        };
      } catch (PMPException e) {
