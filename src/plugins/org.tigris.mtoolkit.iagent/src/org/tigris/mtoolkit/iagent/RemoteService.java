...
public interface RemoteService {
   ...
   * interface) and all of its elements are instances of one the classes listed
   * in step 1, then the collection is returned unchanged.</li>
   * <li>If the value is a array or Collection and at least one of its elements
   * isn't instance of one of the classes listed in the first step, then the
   * value returned is array of java.lang.String with the same size and its
   * elements are the corresponding results from toString() method call on each
   * of the original collection elemenents.</li>
   ...
   * there aren't any users of the service or the service has been unregistered,
   ...
   * 
   * @return true if the service has been unregistered, false if the service is
   *         still available
   * @throws IAgentException
   */
