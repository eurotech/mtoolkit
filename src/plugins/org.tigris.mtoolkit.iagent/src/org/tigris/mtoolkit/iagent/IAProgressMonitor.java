...
/**
 * The <code>IAProgressMonitor</code> provides progress monitoring capabilities
 * in IAgent.
 * 
 * @since 4.0
 */
public interface IAProgressMonitor {
   ...
   * @param totalWork
   *          the total number of work units into which the main task is been
   *          subdivided. If the value is <code>UNKNOWN</code> the
   ...
   * 
   * @param value
   *          <code>true</code> indicates that cancelation has been requested
