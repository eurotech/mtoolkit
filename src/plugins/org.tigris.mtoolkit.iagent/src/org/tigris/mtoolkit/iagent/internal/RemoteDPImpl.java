...
public class RemoteDPImpl implements RemoteDP {
  ...
  public RemoteDPImpl(DeploymentManagerImpl commands, String symbolicName, String version) {
    log("[Constructor] >>> Create new deployment package: manager: " + commands + "; symbolicName: " + symbolicName + "; version: " + version);
  ...
  public RemoteBundle getBundle(String bsn) throws IAgentException {
    ...
    checkState();
    Long bid = (Long) Utils.callRemoteMethod(getDeploymentAdmin(), Utils.GET_DP_BUNDLE_METHOD, new Object[] {this.symbolicName, version, bsn});
    if (bid.longValue() == -2) {
  ...
  private void checkState() {
    if (stale){
      ...
      throw new IllegalStateException("Remote deployment package has been uninstalled or updated with newer version");
    }
  }
  ...
  public Dictionary getBundles() throws IAgentException {
    log("[getBundles] >>>");
    checkState();
    Dictionary bundles = (Dictionary) Utils.callRemoteMethod(getDeploymentAdmin(), Utils.GET_DP_BUNDLES_METHOD, new Object[] {symbolicName, version});
    if (bundles == null) {
  ...
  public String getHeader(String header) throws IAgentException {
    ...
    checkState();
    Object result = Utils.callRemoteMethod(getDeploymentAdmin(), Utils.GET_DP_HEADER_METHOD, new Object[] {symbolicName, version, header});
    if (result == null) {
      ...
      throw new IAgentException("Unknown response from remote method invocation: " + result, IAgentErrors.ERROR_INTERNAL_ERROR);
    }
  }
  ...
  public boolean isStale() throws IAgentException {
    if (!stale) {
      ...
      Boolean result = (Boolean) Utils.callRemoteMethod(getDeploymentAdmin(), Utils.IS_DP_STALE_METHOD, new Object[] {symbolicName, version});
  ...
  public boolean uninstall(boolean force) throws IAgentException {
    ...
    checkState();
    Object result = Utils.callRemoteMethod(getDeploymentAdmin(), Utils.UNINSTALL_DP_METHOD, new Object[] {symbolicName, version, new Boolean(force)});
  ...
  public String toString() {
    return "RemoteDP@" + Integer.toHexString(System.identityHashCode(this)) + "[" + symbolicName + "][" + version + "]";
  }
