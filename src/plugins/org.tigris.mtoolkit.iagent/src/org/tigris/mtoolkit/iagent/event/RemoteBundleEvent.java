...
public class RemoteBundleEvent extends RemoteEvent {
	...
	/**
	 * Constant indicating that a bundle has entered in starting phase. This
	 * state usually is very short and it is discouraged to use it for something
	...
	/**
	 * Constant indicating that a bundle has entered in stopping phase. This
	 * state usually is very short and it is discouraged to use it for something
	 * different purpose than bundle state tracking.
	 * 
	 */
