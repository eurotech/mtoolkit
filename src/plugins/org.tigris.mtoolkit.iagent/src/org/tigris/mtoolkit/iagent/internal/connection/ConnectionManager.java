 ...
 * active connections, creating new connections and adding/removing listeners.
 * <br>
 * 
...
public interface ConnectionManager {
  ...
  public AbstractConnection getActiveConnection(int type)
  ...
  /**
   * Add ConnectionListener, to be notified for connection events. If the passed
   * listener is already present, nothing will be done
   * 
   * @param listener
