...
/**
 * Represents remote deployment package, installed in the remote OSGi runtime.
 * It can be used to query some of the deployment package metadata, its state
 * and perform uninstall (either normal or forced).
 * 
...
public interface RemoteDP {
	 ...
	 * the header is not specified in the DP's manifest, null will be returned.
	 * If the passed header name is null, {@link IllegalArgumentException} will
	 * be thrown.
	 * 
	...
	/**
	 * Returns the symbolic names and versions of the bundles which belongs to
	 * the deployment package.
	 * 
	 * @return Dictionary object where keys are the symbolic names of the
	 *         bundles, and values are the versions.
	 * @throws IAgentException
	 */
	public Dictionary getBundles() throws IAgentException;

	/**
	 * Returns the bundle which has the specified symbolic name and belongs to
	 * the deployment package. If the bundle isn't available in the runtime,
	 * null is returned.
	 * 
	 * @param symbolicName
	 ...
	 * @throws IAgentException
	 * @throws {@link IllegalArgumentException} if the deployment package has
	 *         been removed
	 */
	 ...
	 * @return whether the operation was successful or not. If the underlying
	 *         OSGi throws DeploymentException, its code will be returned as
	 *         code for the thrown IAgentException. If no DeploymentException is
	 *         thrown, then the result of the method will indicate the success
	 *         of the operation
	 * @throws IAgentException
	 */
