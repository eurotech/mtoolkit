...
public interface RemoteBundle extends RemotePackage {
   ...
   *
   * @param flags
   *          options passed to the underlying framework. The supported options
   *          are framework implementation specific. Value "0" means that the
   *          standard start function to be called.
   * @throws IAgentException
   */
   ...
   *          options passed to the underlying framework. The supported options
   *          are framework implementation specific. Value "0" means that the
   *          standard behaviour will be observed.
   * @throws IAgentException
   */
  ...
  /**
   * Invokes refreshPackages through PackageAdmin service (if one is available)
   * with argument null
   */
