...
public interface ServiceManager {
   ...
   * will be thrown.<br>
   * If class and LDAP filter are both non-null and LDAP filter is correct, then
   * the result will be filtered by both criteria.
   * 
   * @param clazz
   ...
   * @return an array containing references to remote services or empty array in
   *         case there aren't any services which satisfies the criteria.
   * @throws IAgentException
   */
