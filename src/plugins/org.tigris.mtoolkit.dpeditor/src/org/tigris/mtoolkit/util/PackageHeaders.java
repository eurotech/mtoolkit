...
public class PackageHeaders {
	...
	/**
	 * returns the contact address of the supplyer of the deployment package.
	...
	/**
	 * Returns a vector containing all non standard headers set for this
	 * package.
	 * 
	...
	/**
	 * Sets a vector containing all additional headers for this deployment
	 * package
	 * 
	 * @param otherHeaders
	 ...
	 * different headers should be separated with ';' and the header and its
	 * value with '\:'
	 * 
	 * @param str
	...
	/**
	 * This method returns a string representation of all additional headers.
	 * The different headers are separated using ';' and the header and its
	 * value by '\:'
	 * 
	...
	/**
	 * removes a single header no matter if its standard or not. The
	 * SymbolicName and the Version headers cannot be removed.
	 * 
	 * @param key
