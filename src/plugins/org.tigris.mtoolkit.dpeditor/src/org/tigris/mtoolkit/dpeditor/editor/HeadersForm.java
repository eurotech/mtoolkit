...
/**
 * The Form that presents the headers page in the Deployment package editor.
 */
public class HeadersForm extends ScrollableForm {
	public static final String TITLE = "DPPEditor.HeadersForm.title";
	...
	private HeadersSection headersSection;
	 ...
	 *            the Form page in which this form will be added
	 */
	public HeadersForm(HeadersFormPage page) {
		this.page = page;
		setVerticalFit(true);
	...
	protected void createFormClient(Composite parent) {
		...
		headersSection = new HeadersSection(page);
		control = headersSection.createControl(parent);
		gd = new GridData(GridData.FILL_BOTH);
		gd.heightHint = control.computeSize(SWT.DEFAULT, SWT.DEFAULT).y;
		control.setLayoutData(gd);

		registerSection(headersSection);
	}
	...
	public void setEditable(boolean editable) {
		editable = false;
		headersSection.setEditable(editable);
	}
}
