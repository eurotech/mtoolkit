...
public abstract class DPPFormPage extends EditorPart implements IDPPEditorPage {
	...
	/**
	 * Checks if can paste in the Form. This is happened only when the focus
	 * control is text field and this text field is enabled and visible,
	 * otherwise return <code>false</code>.
	 * 
	 * @return Returns <code>true</code> if can paste in the form, otherwise
	 *         returns <code>false</code>
	 */
	public boolean canPaste() {
		return form.canPaste();
	}
