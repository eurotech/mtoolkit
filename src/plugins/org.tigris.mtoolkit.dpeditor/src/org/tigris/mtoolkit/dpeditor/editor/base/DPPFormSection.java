 ...
 */
public abstract class DPPFormSection extends FormSection implements IModelChangedListener {
   ...
   * is the same <code>TableItem</code> as a given. The column from which will
   * be get the value is the first one. In this case returns the index of the
  ...
  /**
   * Opens the <code>MessageDialog</code>'s standard error dialog with the given
   * message.
   *
   * @param message
   *          the message
