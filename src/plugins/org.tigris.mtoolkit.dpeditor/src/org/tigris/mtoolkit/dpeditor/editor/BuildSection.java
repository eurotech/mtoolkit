 ...
 */
public class BuildSection extends DPPFormSection implements IFormTextListener, ModifyListener, SelectionListener {
  ...
  /**
   * The browse button, through which the deployment package file can be chosen
   */
  ...
  /**
   * Creates the new instance of the FormSection which parent is the given page
   * form.
   *
   * @param formPage
  ...
  private void createMainFields(Composite container) {
    ...
    text = createText(container,
        ResourceManager.getString(ANT_FILE_LABEL, ""), ResourceManager.getString(ANT_FILE_LABEL, "")); //$NON-NLS-1$
   ...
   *
   * @return <code>true</code> if one of the values of text fields are changed,
   *         and <code>false</code> when no one of the values are changed
   *
  ...
  /**
   * Notifies all listeners of the text fields for the changes of the values and
   * sets this changes.
   *
   ...
   *
   * @param dppFile
   *          the Deployment package file, in which the new value will be set
   * @param info
  ...
  /**
   * Sets to the corresponding <code>BuildInfo</code> object the values from the
   * given text field.
   *
   * @param text
