...
/**
 * The Form that presents the build page in the Deployment package editor.
 */
public class BuildForm extends ScrollableForm {
	public static final String TITLE = "DPPEditor.BuildForm.title";
	 ...
	 *            the Form page in which this form will be added
	 */
	public BuildForm(BuildFormPage page) {
		this.page = page;
		setVerticalFit(true);
	...
	protected void createFormClient(Composite parent) {
		...
		buildSection = new BuildSection(page);
		control = buildSection.createControl(parent);
		gd = new GridData(GridData.FILL_BOTH);
		gd.heightHint = control.computeSize(SWT.DEFAULT, SWT.DEFAULT).y;
		control.setLayoutData(gd);

		registerSection(buildSection);
	}

	/**
	 * Sets if this form will be editable
	 * 
	 * @param editable
