...
public class Form implements PaintListener, IPropertyChangeListener {
	...
	/**
	 * Checks if the given control is instance of <code>Text</code> and checks
	 * if the given <code>id</code> is one of the <code>ActionFactory.CUT</code>
	 ...
	 *         <code>ActionFactory</code> cut, copy, paste, select all or
	 *         delete, <code>false</code> otherwise
	 */
	 ...
	 * Form of the new values of the components and sets that this form is
	 ...
	 * 
	 * @return Returns <code>true</code> if heading is visible,
	 ...
	 *            the value on which depends if the heading will be visible or
	 *            not, <code>true</code> the heading will become visible,
	 ...
	 * the focus control is text field and the action id is one of the cut,
	 * copy, paste, select all and delete).
	 * 
	 * @param actionId
	...
	/**
	 * Checks if can paste in the control which is on focus. This is happened
	 * only when the focus control is text field and this text field is enabled
	 * and visible, otherwise return <code>false</code>.
	 * 
	 * @return Returns <code>true</code> if focus control is text field and is
	 *         visible and enabled, otherwise returns <code>false</code>
	 */
	public boolean canPaste(/* Clipboard clipboard */) {
		...
		if (focusControl instanceof Text) {
			return focusControl.isEnabled() && focusControl.isVisible();
		}
		return false;
	}
}
