...
/**
 * The page form that will be added into the editor. Represents the headers page
 * in the Deployment package editor.
 */
public class HeadersFormPage extends DPPFormPage {
	 ...
	 */
	public HeadersFormPage(DPPEditor editor, String title) {
		super(editor, title);
	}

	/**
	 * Creates the headers form, that will be sets in this page.
	 * 
	 * @return the form of this page
	 * @see org.tigris.mtoolkit.dpeditor.editor.base.DPPFormPage#createForm()
	 */
	protected Form createForm() {
		return new HeadersForm(this);
	}
	...
	public void setEditable(boolean editable) {
		((HeadersForm) getForm()).setEditable(editable);
	}
