...
/**
 * The page form that will be added into the editor. Represents the certificates
 * page in the Deployment package editor.
 */
public class CertificatesFormPage extends DPPFormPage {
	 ...
	 */
	public CertificatesFormPage(DPPEditor editor, String title) {
		super(editor, title);
	}

	/**
	 * Creates the certificates form, that will be exists in this page.
	 * 
	 * @return the form of this page
	 * @see org.tigris.mtoolkit.dpeditor.editor.base.DPPFormPage#createForm()
	 */
	protected Form createForm() {
		return new CertificatesForm(this);
	}
	...
	public void setEditable(boolean editable) {
		((CertificatesForm) getForm()).setEditable(editable);
	}
