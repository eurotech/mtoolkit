...
public class SourceFormPage extends TextEditor implements IDPPEditorPage {
	 ...
	 * they are applied and after they have been applied.
	 */
	...
	/**
	 * Creates new instance of this source form page, sets the editor in which
	 * this page will be added.
	 * 
	 * @param editor
	 *            the parent editor
	 */
	public SourceFormPage(DPPEditor editor) {
		this.editor = editor;
	}
	 ...
	 * <code>createPartControl</code> method to create controls of this form
	 * page.
	 * 
