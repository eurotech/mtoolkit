 ...
 */
public class AntPage extends WizardPage implements ModifyListener, KeyListener, SelectionListener {
  /** Browse button label */
  ...
  private void createFields(Composite container) {
    ...
    antFileText = createText(container,
  ...
  public void modifyText(ModifyEvent e) {
    if (e.getSource().equals(dppFileText)) {
      ...
      File exportDestination = new File(DPPUtilities.replaceString(antFileText.getText(), "<.>",
    ...
    if (e.getSource().equals(antFileText)) {
      ...
      File exportDestination = new File(DPPUtilities.replaceString(value, "<.>", dppFile.getProjectLocation()));
