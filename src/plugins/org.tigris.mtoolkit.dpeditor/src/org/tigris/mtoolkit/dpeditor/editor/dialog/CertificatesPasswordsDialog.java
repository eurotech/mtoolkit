...
public class CertificatesPasswordsDialog extends Dialog implements SelectionListener, ISelectionChangedListener {
  ...
  /**
   * Creates the instance of the CertificatesPasswordsDialog in the given parent
   ...
   */
  public CertificatesPasswordsDialog(Shell parent, Point displayLoc, Point size) {
    super(parent);
  ...
  protected void createButtonsForButtonBar(Composite parent) {
    ...
    createButton(parent, IDialogConstants.CANCEL_ID,
        ResourceManager.getString("DPPEditor.CertificatesSection.SkipButton"), false);
  }
  ...
  public Composite createClient(Composite parent) {
    ...
    errorLabel.setImage(FieldDecorationRegistry.getDefault().getFieldDecoration(FieldDecorationRegistry.DEC_ERROR)
        .getImage());
    errorLabel.setVisible(false);
    ...
    errorLabel.setText(ResourceManager.getString("DPPEditor.CertificatesPasswordsDialog.ErrorLabel"));
  ...
  private void createTable(Composite parent) {
    ...
    String[] columnTitles = {
        ResourceManager.getString("DPPEditor.CertificatesSection.ColAlias"),
    ...
    CellEditor[] editors = new CellEditor[] {
        new TextCellEditor(table), new TextCellEditor(table), new TextCellEditor(table, SWT.PASSWORD),
        new TextCellEditor(table, SWT.PASSWORD)
    };
    String[] properties = {
        "alias", "keystore", "storepass", "keypass"
    };
  ...
  /**
   * Sets the given deployment package file and given project location and sets
   * all certificates info that's no passwords.
   *
   * @param file
   * @param location
   */
  ...
  /**
   * Opens this window, creating it first if it has not yet been created. Opens
   * the window only if there are some jars that was changed.
   *
  ...
  protected void okPressed() {
    ...
    if (!errorLabel.isVisible()) {
      ...
      for (int i = 0; i < certLength; ++i) {
        String storePass = ((CertificateInfo) certsVector.get(i)).getStorepass();
