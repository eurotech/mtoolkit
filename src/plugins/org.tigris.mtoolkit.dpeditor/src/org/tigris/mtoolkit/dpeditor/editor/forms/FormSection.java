...
public abstract class FormSection implements IPropertyChangeListener {
  ...
  /**
   * <code>boolean</code> flag which presents if the form section is changed or
   * not
   */
   ...
   * need to be saved. This method must be overwrite of all classes that extends
   ...
   * be overwrite from the custom implementation of the FormSection class and to
   * put all custom components in this form section.
   *
   * @param parent
  ...
  /**
   * Creates the text field with the given parent and the number of column cells
   * that the control will take up. Creates the label before the text field with
   * the given parent and the given label text and tool tip.
   *
   * @param parent
   *          the parent of the label and text field
   * @param label
   ...
   *          the label tool tip
   * @param span
   *          specifies the number of column cells that the control will take up
   * @return Returns the created text field
   */
  ...
  /**
   * Sets the <code>boolean</code> flag which shows if the header title will be
   * appeared in this FormSection. The default value is <code>true</code>.
   *
