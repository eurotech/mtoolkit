...
public class ChangeBundleJarNameDialog extends Dialog implements SelectionListener, ISelectionChangedListener,
    ICheckStateListener {
  ...
  /**
   * Select or deselect all of the changed bundles jar name in the table depends
   * on the given <code>boolean</code> flag.
   *
   * @param selectAll
  ...
  private void createTable(Composite parent) {
    ...
    Table table = FormWidgetFactory.createTable(container, SWT.SINGLE | SWT.FULL_SELECTION | SWT.CHECK | SWT.H_SCROLL
        | SWT.V_SCROLL);
  ...
  protected Control createButtonBar(Composite parent) {
    ...
    selectAllButton = createButton(composite, IDialogConstants.SELECT_ALL_ID,
        ResourceManager.getString(SELECT_ALL_BUTTON, ""), false);
    selectAllButton.addSelectionListener(this);
    deselectAllButton = createButton(composite, IDialogConstants.DESELECT_ALL_ID,
        ResourceManager.getString(DESELECT_ALL_BUTTON, ""), false);
  ...
  /**
   * Returns a <code>Hashtable</code> filled with all checked jar holders, which
  ...
  /**
   * Returns whether there are the jar files, which not exists and there are new
   * jar version of this jar.
   *
   * @return <code>true</code> if there are changed jar filed, otherwise returns
   *         <code>false</code>
   */
