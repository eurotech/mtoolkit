...
/**
 * The page form that will be added into the editor. Represents the build page
 * in the Deployment package editor.
 */
public class BuildFormPage extends DPPFormPage {
	 ...
	 * added in the form form sections.
	 * 
	 * @param editor
	 *            the parent editor
	 * @param title
	 ...
	 */
	public BuildFormPage(DPPEditor editor, String title) {
		super(editor, title);
	}

	/**
	 * Creates the build form, that will be exists in this page.
	 * 
	...
	public void setEditable(boolean editable) {
		((BuildForm) getForm()).setEditable(editable);
	}
