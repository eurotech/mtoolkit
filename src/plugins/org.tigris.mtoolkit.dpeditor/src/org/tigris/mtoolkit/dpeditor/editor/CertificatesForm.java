...
/**
 * The Form that presents the certificates page in the Deployment package
 * editor.
 */
public class CertificatesForm extends ScrollableForm {
	public static final String TITLE = "DPPEditor.CertificateForm.title";
	...
	private CertificatesSection certificateSection;
	 ...
	 *            the Form page in which this form will be added
	 */
	public CertificatesForm(CertificatesFormPage page) {
		this.page = page;
		setVerticalFit(true);
	...
	protected void createFormClient(Composite parent) {
		...
		certificateSection = new CertificatesSection(page);
		control = certificateSection.createControl(parent);
		gd = new GridData(GridData.FILL_BOTH);
		gd.heightHint = control.computeSize(SWT.DEFAULT, SWT.DEFAULT).y;
		control.setLayoutData(gd);

		registerSection(certificateSection);
	}
	...
	public void setEditable(boolean editable) {
		editable = false;
		certificateSection.setEditable(editable);
	}
}
