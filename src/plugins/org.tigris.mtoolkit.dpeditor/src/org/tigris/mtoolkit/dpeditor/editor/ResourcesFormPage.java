...
/**
 * The page form that will be added into the editor. Represents the resources
 * page in the Deployment package editor.
 */
public class ResourcesFormPage extends DPPFormPage {
	...
	/**
	 * Creates new instance of this form page, sets the editor in which this
	 ...
	 */
	public ResourcesFormPage(DPPEditor editor, String title) {
		super(editor, title);
	}

	/**
	 * Creates the resources form, that will be sets in this page.
	 * 
	 * @return the form of this page
	 * @see org.tigris.mtoolkit.dpeditor.editor.base.DPPFormPage#createForm()
	 */
	protected Form createForm() {
		return new ResourcesForm(this);
	}
	...
	public void setEditable(boolean editable) {
		((ResourcesForm) getForm()).setEditable(editable);
	}
