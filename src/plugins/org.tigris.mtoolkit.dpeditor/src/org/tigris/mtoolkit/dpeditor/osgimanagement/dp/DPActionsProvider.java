...
import org.tigris.mtoolkit.dpeditor.osgimanagement.dp.actions.DPPropertiesAction;
import org.tigris.mtoolkit.dpeditor.osgimanagement.dp.actions.InstallDPAction;
import org.tigris.mtoolkit.dpeditor.osgimanagement.dp.actions.UninstallDPAction;
import org.tigris.mtoolkit.dpeditor.osgimanagement.dp.model.DeploymentPackage;
import org.tigris.mtoolkit.dpeditor.util.ImageHolder;
...
public class DPActionsProvider implements ContentTypeActionsProvider {
  ...
  public void fillToolBar(ToolBarManager tbm) {
    Action[] actions = new Action[] {
        installDPAction, uninstallDPAction, dpPropertiesAction
    };
  ...
  public Image getImage(Model node) {
    ...
    } else if (node instanceof SimpleNode && "Deployment Packages".equals(node.getName())) {
