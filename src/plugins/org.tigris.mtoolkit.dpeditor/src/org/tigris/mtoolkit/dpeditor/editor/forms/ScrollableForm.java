...
public class ScrollableForm extends Form {
  ...
  /**
   * Creates the parent composite, in which is placed a ScrolledComposite, which
   * provides scrollbars and will scroll its content when the user uses the
   * scrollbars.
   *
   * @param parent
   *          a composite control which will be the parent of the new instance
  ...
  /**
   * Checks if the ScrolledComposite resize the content object to be as wide and
   * as tall as the ScrolledComposite.
   *
  ...
  /**
   * Sets the flag, which is responsible to create the ScrolledComposite or the
   * regular Composite.
   *
   * @param newScrollable
  ...
  /**
   * Sets the flag, which is responsible to the created ScrolledComposite resize
   * the content object to be as wide and as tall as the ScrolledComposite or
   * not.
   *
