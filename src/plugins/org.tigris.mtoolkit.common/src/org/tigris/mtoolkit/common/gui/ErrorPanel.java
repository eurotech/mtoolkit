...
public final class ErrorPanel extends Composite {
  ...
  /**
   * Style constant for initially expanded state. When this constant is set, the
   * error panel will show details area by default.
   */
  ...
  /**
   * Constructs new {@link ErrorPanel} with given parent, panel style and style
  ...
  private void createDetailsArea() {
    ...
    boolean expanded = (panelStyle & EXPANDED) != 0;
    detailsArea.setVisible(expanded);
    detailsAreaShowed = expanded;
