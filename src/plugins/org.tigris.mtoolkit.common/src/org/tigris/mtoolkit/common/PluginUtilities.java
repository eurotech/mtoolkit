...
public class PluginUtilities {
  ...
  static {
  	char[] chars = null;
	    ...
	    //taken from http://support.microsoft.com/support/kb/articles/q177/5/06.asp				
      chars = new char[]{'"', '*', '/', ':', '<', '>', '?', '\\', '|'};
...
//icobgr: Binary search not needed for this small array        
//				if (Arrays.binarySearch(INVALID_RESOURCE_CHARACTERS, pathName.charAt(i)) >= 0) {
//				  return false;
//				}
			}
			return true;
  ...
  /**
   * This method is used for compare two strings. It is used for
   * comparing file names, because only on Windows OS letters case
   * are independenet.
   * 
   * @param str1 - the first string
   * @param str2 - the second string
   * @return <code>TRUE</code> if string equals, otherwise returns <code>FALSE</code>
   */
