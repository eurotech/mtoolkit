...
public final class InteractiveConnectionHandler extends SSLSocketFactory implements HostnameVerifier {
  ...
  private InteractiveConnectionHandler(SSLSocketFactory privateFactory, SSLSocketFactory defaultFactory,
      HostnameVerifier privateVerifier, HostnameVerifier defaultVerifier) {
  ...
  public static Object executeWithInteraction(Operation operation) throws Exception { // NO_UCD
  ...
  // @NotThreadSafe
  public static void setUserInteraction(UserInteraction aUserInteraction) { // NO_UCD
  ...
  private static InteractiveConnectionHandler createInteractiveConnectionHandler(SSLSocketFactory oldSocketFactory,
    ...
    InteractiveConnectionHandler factory = new InteractiveConnectionHandler(createInteractiveSocketFactory(null),
        oldSocketFactory, getHostnameVerifier(), oldVerifier);
    return factory;
  }
  ...
  private static class UserInteractionWrapper implements UserInteraction {
    /* (non-Javadoc)
     * @see org.tigris.mtoolkit.common.security.UserInteraction#confirmConnectionTrust(int, java.lang.String, java.lang.String, java.security.cert.X509Certificate[])
     */
    public boolean confirmConnectionTrust(int validationResult, String message, String host, X509Certificate[] certChain) {
      ...
      UtilitiesPlugin.warning("SSL certificate requested, but the dialog failed to show", null);
      return false;
    }
  }
