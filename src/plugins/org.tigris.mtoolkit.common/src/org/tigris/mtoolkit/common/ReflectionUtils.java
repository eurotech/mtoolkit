...
public final class ReflectionUtils {
  ...
  private static Object doInvokeMethod(Object obj, String methodName, Class[] parameterTypes, Object[] parameterValues,
      boolean invokeProtected) throws InvocationException {
    if (obj == null) {
   ...
   * @since 5.0
   */
  public static Object invokeProtectedMethod(Object obj, String methodName, Class[] parameterTypes,
  ...
  public static class InvocationException extends Exception {
    ...
    public InvocationException(String message, Throwable cause) { // NO_UCD
      super(message, cause);
    }

    public InvocationException(String message) { // NO_UCD
      super(message);
    }
