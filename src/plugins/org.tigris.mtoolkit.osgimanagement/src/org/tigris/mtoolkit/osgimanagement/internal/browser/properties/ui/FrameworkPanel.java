...
public class FrameworkPanel implements ConstantsDistributor, SelectionListener, DeviceTypeProviderValidator {
	...
	public static class DeviceTypeProviderElement {
		...
		public DeviceTypeProviderElement(IConfigurationElement configurationElement,
				DeviceTypeProviderValidator validator) throws CoreException {
	...
	public void widgetSelected(SelectionEvent e) {
		if (e.getSource() == deviceTypeCombo) {
			...
			if (selectedIdx != -1) {
				DeviceTypeProviderElement newProvider = (DeviceTypeProviderElement) deviceTypesProviders
						.get(selectedIdx);
