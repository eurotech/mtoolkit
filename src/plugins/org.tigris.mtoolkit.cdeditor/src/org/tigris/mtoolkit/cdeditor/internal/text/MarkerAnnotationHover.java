/*******************************************************************************
 * Copyright (c) 2000, 2009 ProSyst Software GmbH and others.
...
// XXX: Copied code from org.eclipse.pde.internal.ui.editor.text.AnnotationHover
public class MarkerAnnotationHover implements IAnnotationHover {
	...
	public String getHoverInfo(ISourceViewer sourceViewer, int lineNumber) {
		...
		for (int i = 0; i < messages.length; i++) {
			buffer.append("- ").append(messages[i]);
