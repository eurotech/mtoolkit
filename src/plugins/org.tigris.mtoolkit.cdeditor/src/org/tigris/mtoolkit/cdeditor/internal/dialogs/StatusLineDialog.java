...
import org.tigris.mtoolkit.cdeditor.widgets.StatusLine;

/**
 * StatusLineDialog is base class for the dialogs that have need to display 
 * the validation status of current entered data in the dialog fields.
 */
...
public class StatusLineDialog extends TrayDialog {
	...
	/**
	 * Updates the current status with supplied status.
